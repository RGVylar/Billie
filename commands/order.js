...
module.exports = {
    ...
    execute(msg, args) {
      ...
      .addField('2.  Kisumonogatari', '3 Movies', true)
      .addField('3.  Nisemonogatari', '11 Episodes', true)
      .addField('4.  Nekomonogatari', '4 Episodes', true)
      .addField('5.  Monogatari series:\nsecond season', '25 Episodes (+3 Recaps)', true)
      .addField('6.  Hanamonogatari', '5 Episodes', true)
      .addField('7.  Tsukimonogatari', '4 Episodes', true)
      .addField('8.  Owarimonogatari', '13 Episodes', true)
      .addField('9.  (Alt) Kizumonogatari', '3 Movies (Alternative Placement)', true)
